...
from ..._operations._operations import (
    build_mmav3_stats_event_request,
    build_mmav3_stats_fight_request,
    build_mmav3_stats_fighter_request,
    build_mmav3_stats_fighters_request,
    build_mmav3_stats_leagues_request,
    build_mmav3_stats_schedule_request,
)
from .._vendor import MMAV3StatsMixinABC
...
class MMAV3StatsOperationsMixin(MMAV3StatsMixinABC):
    ...
    async def leagues(self, format: str = "XML", **kwargs: Any) -> List[JSON]:
        """Leagues.
    ...
    @distributed_trace_async
    async def fighters(self, format: str = "XML", **kwargs: Any) -> List[JSON]:
        """Fighters.
    ...
    @distributed_trace_async
    async def schedule(self, league: str, season: str, format: str = "XML", **kwargs: Any) -> List[JSON]:
        """Schedule.
    ...
    @distributed_trace_async
    async def event(self, eventid: str, format: str = "XML", **kwargs: Any) -> JSON:
        """Event.
    ...
    @distributed_trace_async
    async def fight(self, fightid: str, format: str = "XML", **kwargs: Any) -> JSON:
        """Fight.
    ...
    @distributed_trace_async
    async def fighter(self, fighterid: str, format: str = "XML", **kwargs: Any) -> JSON:
        """Fighter.
